...
import {
	Product,
	ProductSchema,
} from 'src/microservices/inventory/entities/product.entity';
...
import {
	Customer,
	CustomerSchema,
} from 'src/microservices/customers/entities/customer.entity';
import {
	Order,
	OrderSchema,
} from 'src/microservices/order/entities/order.entity';
